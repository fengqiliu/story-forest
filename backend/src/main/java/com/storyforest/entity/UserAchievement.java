...
public class UserAchievement {
    ...
    @Schema(description = "勋章 ID", requiredMode = Schema.RequiredMode.REQUIRED)
    @Column(name = "achievement_id", nullable = false)
    private Long achievementId;

    @Schema(description = "达成时间", accessMode = Schema.AccessMode.READ_ONLY)
    @CreationTimestamp
